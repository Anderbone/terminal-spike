# Built-in Mosh dependency inventory
...
| Kotlin standard library | 2.4.10 | Android broker and worker service implementation | JetBrains Kotlin | Apache-2.0 notice. |
